...
import WareHousePopupFilterDialog from "./WareHousePopupFilter";

export const WareHousePopupFilter = (field, taxData,setWareHouseData,inputvalue, setInputValue, handleChange) => {
  ...
  const handleDialogItemClick = (e,fieldname) => {
    //const selectedItem = e.detail.item.textContent;
    const filteredList = taxData.filter((item) => {
...
console.log("filteredList",filteredList)
    console.log("selectedItem", e.detail.item.innerHTML,taxData,fieldname);
    setWareHouseData(filteredList)
    ...
    case "select":
      return (
        <FlexBox direction="Column">
          ...
          <WareHousePopupFilterDialog
            filterdialogOpen={filterdialogOpen}
            setFilterDialogOpen={setFilterDialogOpen}
            itempopupData={taxData}
