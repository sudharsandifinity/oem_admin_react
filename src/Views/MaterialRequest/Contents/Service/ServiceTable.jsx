      ...
      },
      {
      ...
      },
       {
              ...
              Cell: ({ row }) => (
                <>
                  <Input
                    value={row.original.UOMCode ? row.original.UOMCode : ""}
                    readonly
                    disabled={mode === "view"}
                    style={{ textAlign: "right" }}
                    onFocus={(e) =>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "UOMCode")}
                  />
                </>
              ),
            },
      
            {
              ...
              Cell: ({ row }) => (
                <>
                  <Input
                    value={row.original.StageCode ? row.original.StageCode : ""}
                    readonly
                    disabled={mode === "view"}
                    style={{ textAlign: "right" }}
                    onFocus={(e) =>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "StageCode")}
                  />
                </>
              ),
            },
              ...
              Cell: ({ row }) => (
                <>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "IssuedQty")}
                  />
                </>
              ),
            },
              ...
              Cell: ({ row }) => (
                <>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "InStock")}
                  />
                </>
              ),
            },
              ...
              Cell: ({ row }) => (
                <>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "AvailableQty")}
                  />
                </>
              ),
            },
              ...
              Cell: ({ row }) => (
                <>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "RateTotal")}
                  />
                </>
              ),
            },
              ...
              Cell: ({ row }) => (
                <>
                  ...
                  <Button
                    icon="sap-icon://sys-minus"
                    design="Transparent"
                    onClick={() => clearCellValue(row.index, "Remarks")}
                  />
                </>
              ),
            },
