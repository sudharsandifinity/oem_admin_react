...
const MenuManagement = () => {
  ...
  const handleEdit = (menu) => {
    navigate(`/CustomerAdmin/MenuManagement/edit/${menu.id}`);
  };
      ...
      <FlexBox direction="Column" style={{ width: "100%" }}>
        <AppBar
          ...
          startContent={
            <div style={{ width: "250px" }}>
              ...
              >
                ...
                <BreadcrumbsItem data-route="/CustomerAdmin/MenuManagement">
                  MenuManagement
                </BreadcrumbsItem>
              </Breadcrumbs>
            </div>
          ...
          endContent={
            <Button
              design="default"
              onClick={() => navigate("/CustomerAdmin/MenuManagement/create")}
            >
              Add Menu
            </Button>
          }
