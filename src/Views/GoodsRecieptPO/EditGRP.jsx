...
import { fetchPurchaseDeliveryNotesById, updatePurchaseDeliveryNotes } from "../../store/slices/purDeliveryNoteSlice";
...
TaxDate: formData.TaxDate
      ...
      let  res = await dispatch(
          updatePurchaseDeliveryNotes({ id:docNo, data: formDataToSend }),
        ).unwrap();
