...
export default function CreateGRP() {
  ...
  const [formDetails, setFormDetails] = useState([{name:"GRP",FormTabs:[]}]);
  ...
  const handleSubmit = async () => {
    try {
      ...
      let res = await dispatch(createPurchaseDeliveryNotes(formDataToSend)).unwrap();
  ...
  return (
    <>
      ...
      <ObjectPage
        ...
        headerArea={
          <DynamicPageHeader  className="custom-header"
            style={{
              display: "flex",
              alignItems: "center",
              padding: "1rem",
            ...
            breadcrumbs={
               <div style={{ width: "500px" }}>
                ...
                >
                  ...
                  <BreadcrumbsItem data-route={`/GRP`}>
                   GRP List
                  </BreadcrumbsItem>
                  <BreadcrumbsItem>
                    {formDetails
      ...
      <Dialog open={open} onAfterClose={() => setOpen(false)}>
        ...
        >
          ...
          <Button
            design="Emphasized"
            onClick={() => {
              apiError ? setOpen(false):navigate(`/GRP`) ;
            }}
          >
            OK
          </Button>
